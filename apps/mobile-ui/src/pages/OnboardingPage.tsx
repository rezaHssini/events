...
export default function OnboardingPage() {
  ...
  return (
    <div className="relative mx-auto flex min-h-screen max-w-md flex-col ios-mesh-bg">
      ...
      <div className="sticky bottom-0 z-20 shrink-0 border-t border-white/10 bg-[#0a0a0f]/92 px-4 pt-3 pb-[max(env(safe-area-inset-bottom,0px),16px)] backdrop-blur-xl">
        {step === 0 ? (
          <button
            type="button"
            onClick={() => setStep(1)}
