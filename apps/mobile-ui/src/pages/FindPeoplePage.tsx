      ...
      <header className="sticky top-0 z-40 border-b border-white/10 bg-[#0a0a0f]/90 px-4 py-4 backdrop-blur-xl">
        <div className="flex items-center gap-3">
          ...
          <div className="flex-1 text-left">
            <h1 className="text-xl font-bold gradient-text">Find People</h1>
            <p className="text-xs text-slate-400">Discover friends & event buddies</p>
          </div>
        </div>
        <div className="mt-3 flex items-center gap-2 rounded-xl bg-white/10 px-4 py-2.5">
          <span>🔍</span>
          <input
            value={query}
