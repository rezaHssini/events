  ...
  return (
    ...
    >
      ...
      <div className="px-4 py-4 text-left">
        ...
        <button
          type="button"
          onClick={() => requireLogin(() => navigate('/checkout', { state: { eventId: event.id, event } }))}
          className="ios-button mt-3 block w-full py-3 text-center text-[15px]"
        >
          Get Tickets
        </button>
      </div>
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-5 border-t border-white/5 px-4 py-3">
        <button type="button" onClick={() => requireLogin(liked)} className="flex items-center gap-1.5 text-slate-400 hover:text-pink-400">
