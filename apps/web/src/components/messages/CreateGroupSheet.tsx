...
export function CreateGroupSheet({
  ...
  const create = () => {
    ...
    const members = [ME, ...friends.filter((f) => selected.includes(f.id))]
          ...
          {step === 'details' ? (
            <>
              <button
                ...
                className="relative mx-auto block w-full overflow-hidden rounded-2xl ring-1 ring-white/10"
              >
                <img src={avatar} alt="" className="h-32 w-full object-cover" />
            ...
            <>
              <p className="ios-caption">Select at least one friend. You can add more later.</p>
