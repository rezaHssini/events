    ...
    <div className="relative">
      ...
      {imageUrl && (
        <div className="relative mb-2 inline-block">
          <img src={imageUrl} alt="" className="h-20 rounded-xl object-cover ring-1 ring-white/10" />
          <button
            type="button"
            onClick={() => setImageUrl(undefined)}
            className="absolute -right-2 -top-2 flex h-6 w-6 items-center justify-center rounded-full bg-black/80"
      ...
      <div className="flex gap-2">
        <button
          ...
          className="flex h-10 w-10 shrink-0 items-center justify-center self-end rounded-xl glass text-[#0a84ff]"
      ...
      <p className="mt-1.5 text-[10px] text-slate-500">Type @ to mention · tap 📷 for camera or gallery</p>
        ...
        <div className="flex-1 min-w-0 text-left">
          ...
          {comment.imageUrl && (
            <img
              ...
              alt=""
              className="mt-2 max-h-48 rounded-xl object-cover ring-1 ring-white/10"
            />
          )}
