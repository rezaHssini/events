...
export default function ClubPageEditor() {
  ...
  return (
    <div className="min-h-screen pb-8">
      <ClubBackHeader title="Manage planner page" subtitle="Public brand page — not your personal profile" />

      <div className="p-4">
        <div className="mb-5 rounded-2xl border border-secondary/30 bg-secondary/5 p-3 text-left text-sm">
        ...
        {/* Preview */}
        <div className="mb-5 overflow-hidden rounded-2xl glass">
          ...
          <div className="relative -mt-8 px-4 pb-4 text-left">
            <button type="button" onClick={() => setPicker('avatar')}>
              <img src={avatar} alt="" className="h-16 w-16 rounded-2xl border-4 border-[#14141f] object-cover" />
            </button>
