...
export default function ClubTeamPage() {
  ...
  return (
    <div className="min-h-screen pb-8">
      <ClubBackHeader title="Team" subtitle="Club-wide roster — assign per event in event settings" />
      ...
      <BottomSheet open={inviteOpen} onClose={() => setInviteOpen(false)} title="Invite team member">
        ...
        <button type="button" onClick={sendInvite} className="ios-button w-full py-3">Send invite</button>
      </BottomSheet>
    </div>
  )
}
