...
import { buildExtraEvents } from './extraEvents'
...
export const events: Event[] = [...coreEvents, ...buildExtraEvents(creators)]
...
export const feedPostsFollowing = [
  ...
  { type: 'event' as const, event: events[6], feedTag: 'following' as const },
  ...
  { type: 'event' as const, event: events[12], feedTag: 'following' as const },
  { type: 'memory' as const, memory: memories[1], feedTag: 'following' as const },
  { type: 'event' as const, event: events[16], feedTag: 'following' as const },
  ...
  { type: 'event' as const, event: events[9], feedTag: 'following' as const },
  { type: 'announcement' as const, creator: creators, text: 'Gallery Walk this Thursday — RSVP for free entry 🎨', feedTag: 'following' as const },
]

const nearbyDistances = ['0.3 mi', '0.5 mi', '0.8 mi', '1.1 mi', '1.2 mi', '1.5 mi', '1.8 mi', '2.0 mi', '2.3 mi', '2.8 mi']

export const feedPostsNearby = events
  .filter((e) => e.status !== 'past')
  .slice(0, 12)
  .map((event, i) => ({
    type: 'event' as const,
    event,
    distance: nearbyDistances[i % nearbyDistances.length],
    feedTag: 'nearby' as const,
  }))

export const feedPostsTrending = [
  { type: 'event' as const, event: events[0], trendingRank: 1, feedTag: 'trending' as const },
  { type: 'event' as const, event: events[11], trendingRank: 2, feedTag: 'trending' as const },
  { type: 'memory' as const, memory: { ...memories[0], likes: 1204 }, feedTag: 'trending' as const },
  { type: 'event' as const, event: events[4], trendingRank: 3, feedTag: 'trending' as const },
  { type: 'event' as const, event: events[12], trendingRank: 4, feedTag: 'trending' as const },
  { type: 'event' as const, event: events[1], trendingRank: 5, feedTag: 'trending' as const },
  { type: 'memory' as const, memory: memories[2], feedTag: 'trending' as const },
  { type: 'event' as const, event: events[16], trendingRank: 6, feedTag: 'trending' as const },
]
